...
<!--Reputation-->
		<div class="card" style="padding:20px 20px 5px 20px;margin-top:20px">
			...
			<div class="panel panel-warning">
			  ...
			  <div class="panel-body"><?php echo $review; ?></div>
			</div>
			<div class="panel panel-warning">
			  <div class="panel-heading">Ratings</div>
			  <div class="panel-body"><?php echo $rating; ?></div>
			</div>
		</div>
<!--End Reputation-->
...
<!--My Wallet-->
		<div class="card" style="padding:20px 20px 5px 20px;margin-top:20px">
			...
			<ul class="list-group">
			  <li class="list-group-item">Hourly Rate: <?php echo $rate; ?></li>
			  <li class="list-group-item">Payment: <?php echo $payment ?> </li>
			</ul>
		</div>
<!--End My Wallet-->
