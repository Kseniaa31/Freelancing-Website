...
if(isset($_POST["s_budget"])){
	$t=$_POST["s_budget"];
	$sql = "SELECT * FROM job_offer WHERE budget='$t' and valid=1";
	$result = $conn->query($sql);
}
...
<!--Main profile card-->
		<div class="card" style="padding:20px 20px 5px 20px;margin-top:20px">
	        ...
	        <form action="allJob.php" method="post">
				<div class="form-group">
				  <input type="text" class="form-control" name="s_budget">
				  <center><button type="submit" class="btn btn-info">Search by Budget</button></center>
				</div>
	        </form>

	        <form action="allJob.php" method="post">
				<div class="form-group">
				  <center><button type="submit" name="recentJob" class="btn btn-warning">See recently posted jobs first</button></center>
				</div>
	        </form>

	        <form action="allJob.php" method="post">
				<div class="form-group">
				  <center><button type="submit" name="oldJob" class="btn btn-warning">See older posted jobs first</button></center>
				</div>
	        </form>
