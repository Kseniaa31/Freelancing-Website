...
<nav class="navbar navbar-inverse navbar-fixed-top" id="my-navbar">
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="navbar-collapse">
			<a href="register.php" class="btn btn-info navbar-btn navbar-right">Register</a>
	...
	<div class="col-lg-4">
		<div class="jumbotron">
			<div class="container text-center">
				<h1>Freelance's Corner</h1>
				<p>Recognize the value of time as a precious resource. Utilize it wisely instead of letting it slip away while others are getting things done here.</p>
				...
				<div class="btn-group">
					...
					<a href="#category" type="button" class="btn btn-info">Categories</a>
				</div>
			</div>
		</div>	
	</div>
		  ...
		  <div class="carousel-inner" role="listbox">
		    <div class="item active">
		      ...
		      <div class="carousel-caption">
		        <h3>Work</h3>
		        <p>Strive and give your best to succeed.</p>
		      </div>
		    </div>
		    ...
		    <div class="item">
		      ...
		      <div class="carousel-caption">
		        <h3>Time</h3>
		        <p>Avoid wasting valuable time.</p>
		      </div>
		    </div>
		    ...
		    <div class="item">
		      ...
		      <div class="carousel-caption">
		        <h3>Believe</h3>
		        <p>Have constant faith in yourself.</p>
		      </div>
		    </div>
		  </div>
	...
	<div class="row">
		<div class="col-lg-4">
			<div class="card" style="padding:20px 40px 20px 40px;margin:20px;">
				<a href="login.php"><span class="glyphicon glyphicon-credit-card"></span>
				<h3>Web Developer</h3>
		...
		<div class="col-lg-4">
			<div class="card" style="padding:20px 40px 20px 40px;margin:20px;">
				<a href="login.php"><span class="glyphicon glyphicon-phone"></span>
		...
		<div class="col-lg-4">
			<div class="card" style="padding:20px 40px 20px 40px;margin:20px;">
				<a href="login.php"><span class="glyphicon glyphicon-picture"></span>
		...
		<div class="col-lg-4">
			<div class="card" style="padding:20px 40px 20px 40px;margin:20px;">
				<a href="login.php"><span class="glyphicon glyphicon-pencil"></span>
		...
		<div class="col-lg-4">
			<div class="card" style="padding:20px 40px 20px 40px;margin:20px;">
				<a href="login.php"><span class="glyphicon glyphicon-signal"></span>
		...
		<div class="col-lg-4">
			<div class="card" style="padding:20px 40px 20px 40px;margin:20px;">
				<a href="login.php"><span class="glyphicon glyphicon-headphones"></span>
...
<div class="container text-center" style="padding:4%;" id="faq">
  ...
  <div id="demo3" class="collapse">
  	<div class="card" style="padding:20px 40px 20px 40px;">
  		<h4>No. Freelance'S Corner is absolutely free to register and explore the posted job offers, freelancers and employers.</h4>
  	</div>
  </div>
  </div>
</div>
